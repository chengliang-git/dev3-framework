package com.enterprise.framework.generator;
...
public class CodeGenerator {
    ...
    public static class GeneratorProperties {
        private String author = "Enterprise Framework";
        private String packageName = "com.enterprise.framework";
        private String tablePrefix = "t_";
        private List<String> excludeColumns = Arrays.asList("id", "create_time", "update_time", "deleted");
